...
function GlitchText({ children }: { children: string }) {
  return (
    <span className="glitch-wrapper relative inline-block">
      ...
      <span
        className="glitch-layer glitch-green absolute inset-0 text-[#00ff00] opacity-40 hidden sm:block"
        aria-hidden="true"
      >
        {children}
      </span>
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden px-5">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center pt-20 sm:pt-24 animate-fade-in-up">
        ...
        <h1 className="font-display text-display-xl font-bold tracking-tight mb-4 sm:mb-6 text-balance">
